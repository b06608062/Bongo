      ...
      <MySideer>
        <div className="head-shot-box">
          <Avatar
            className="head-shot"
            src={headShotURLs[me]}
            onClick={() => setEditHeadShotModal(true)}
            sx={{ cursor: "pointer" }}
          />
        </div>
        <div className="info-box">
          <div className="flex-row-header">
            <Typography sx={{ fontSize: "2rem", fontWeight: "bolder" }} noWrap>
              {me}
            </Typography>
            <button className="edit-info-btn" onClick={handleOpenEditInfoModal}>
              Edit Info
            </button>
          </div>
          {!ME.me.about &&
          ...
          {ME.me.position ? (
            <div className="flex-row">
              <img className="image" src={portfolioIcon} />
              <Typography
                sx={{ fontSize: "1.2rem" }}
                noWrap
              >{`${ME.me.position} at ${ME.me.company}`}</Typography>
            </div>
          ) : (
            <></>
          )}
          {ME.me.school ? (
            <div className="flex-row">
              <img className="image" src={schoolIcon} />
          ...
          {ME.me.from ? (
            <div className="flex-row">
              <img className="image" src={homeIcon} />
              <Typography
                sx={{ fontSize: "1.2rem" }}
                noWrap
              >{`From ${ME.me.from}`}</Typography>
            </div>
          ) : (
            <></>
          )}
          {ME.me.liveIn ? (
            <div className="flex-row">
              <img className="image" src={liveInIcon} />
              <Typography
                sx={{ fontSize: "1.2rem" }}
                noWrap
              >{`Now in ${ME.me.liveIn}`}</Typography>
            </div>
          ) : (
            <></>
          )}
          {ME.me.birthday ? (
            <div className="flex-row">
              <img className="image" src={birthdayIcon} />
              <Typography sx={{ fontSize: "1.2rem" }} noWrap>
                {ME.me.birthday}
              </Typography>
            </div>
          ...
          {ME.me.phone ? (
            <div className="flex-row">
              <img className="image" src={phoneIcon} />
              <Typography sx={{ fontSize: "1.2rem" }} noWrap>
                {ME.me.phone}
              </Typography>
            </div>
          ...
          {ME.me.email ? (
            <div className="flex-row">
              <img className="image" src={mailIcon} />
              <Typography sx={{ fontSize: "1.2rem" }} noWrap>
                {ME.me.email}
              </Typography>
            </div>
          ...
          {ME.me.github ? (
            <div className="flex-row">
              ...
              <Typography sx={{ fontSize: "1.2rem" }} noWrap>
                <a href={ME.me.github} target="_blank">
                  {ME.me.github}
                </a>
              </Typography>
            </div>
          ...
          {ME.me.instagram ? (
            <div className="flex-row">
              ...
              <Typography sx={{ fontSize: "1.2rem" }} noWrap>
                <a href={ME.me.instagram} target="_blank">
                  {ME.me.instagram}
                </a>
              </Typography>
            </div>
          ...
          {ME.me.website ? (
            <div className="flex-row">
              <img className="image" src={websiteIcon} />
              <Typography sx={{ fontSize: "1.2rem" }} noWrap>
                <a href={ME.me.website} target="_blank">
                  {ME.me.website}
                </a>
              </Typography>
            </div>
        ...
        <Modal
          title="Edit Info"
          visible={openEditInfoModal}
          onOk={handleEditInfo}
          onCancel={handleCloseEditInfoModal}
        >
          <Form>
        ...
        <Modal
          ...
          visible={openEditHeadShotModal}
          onCancel={handleCloseEditHeadShotModal}
          onOk={handleUpdateHeadShotByIMGUR}
        >
          <>
