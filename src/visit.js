      ...
      {loading ? (
        ...
        <>
          <MySideer>
            ...
            <div className="info-box">
              <div className="flex-row-header">
                ...
                {ME.me.friends.some((friend) => friend === visit) ? (
                  <button className="friend-btn" disabled>
                    Friend
                  </button>
                ) : ME.me.requests.some((request) => request === visit) ? (
                  <button className="friend-btn" disabled>
                    Wait For Confirmation
                  </button>
                ) : ME.me.invitations.some(
                    (invitation) => invitation === visit
                  ) ? (
                  <button
                    className="friend-btn"
                    onClick={() =>
                      acceptRequest({ variables: { from: me, to: visit } })
                    }
                  ...
                  <button
                    className="friend-btn"
                    onClick={() =>
                      addFriend({ variables: { from: me, to: visit } })
                    }
                    style={{ cursor: "pointer" }}
                  >
                    Add Friend
              ...
              {VISIT.visit.position ? (
                <div className="flex-row">
                  ...
                  <Typography
                    sx={{ fontSize: "1.2rem" }}
                    noWrap
                  >{`${VISIT.visit.position} at ${VISIT.visit.company}`}</Typography>
                </div>
              ) : (
                <></>
              )}
              ...
              {VISIT.visit.from ? (
                <div className="flex-row">
                  ...
                  <Typography
                    sx={{ fontSize: "1.2rem" }}
                    noWrap
                  >{`From ${VISIT.visit.from}`}</Typography>
                </div>
              ) : (
                <></>
              )}
              {VISIT.visit.liveIn ? (
                <div className="flex-row">
                  ...
                  <Typography
                    sx={{ fontSize: "1.2rem" }}
                    noWrap
                  >{`Now in ${VISIT.visit.liveIn}`}</Typography>
                </div>
              ) : (
                <></>
              )}
              ...
              {VISIT.visit.github ? (
                <div className="flex-row">
                  ...
                  <Typography sx={{ fontSize: "1.2rem" }} noWrap>
                    <a href={VISIT.visit.github} target="_blank">
                      {VISIT.visit.github}
                    </a>
                  </Typography>
                </div>
              ...
              {VISIT.visit.instagram ? (
                <div className="flex-row">
                  ...
                  <Typography sx={{ fontSize: "1.2rem" }} noWrap>
                    <a href={VISIT.visit.instagram} target="_blank">
                      {VISIT.visit.instagram}
                    </a>
                  </Typography>
                </div>
              ...
              {VISIT.visit.website ? (
                <div className="flex-row">
                  ...
                  <Typography sx={{ fontSize: "1.2rem" }} noWrap>
                    <a href={VISIT.visit.website} target="_blank">
                      {VISIT.visit.website}
                    </a>
                  </Typography>
                </div>
          ...
          <Posts
            navigate={navigate}
            me={me}
            POST={{ post: POST.post.filter((post) => post.author === visit) }}
            home={false}
