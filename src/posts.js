    ...
    <>
      {POST && headShotURLs ? (
        <>
          ...
          <MyContent>
            <Modal
              title={openCreatePostModal ? "Create Post" : "Edit Post"}
              visible={openCreatePostModal || openEditPostModal}
              onCancel={handleCloseCreatePostModal}
              onOk={openCreatePostModal ? handleCreatePost : handleEditPost}
            >
              <Radio.Group
              ...
              <Input
                ...
                maxLength={400}
              />
              <Image src={image} fallback={DEFAULT_IMAGE} />
            </Modal>
            {visit ? (
              <></>
            ) : (
